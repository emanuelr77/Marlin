...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 10, 25 } // ...or, set your own edit limits (E limited to 25 for dual drive)
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 500 } // E reduced from 1000 to 500 for dual drive (less vibration on retract)
...
#define DEFAULT_RETRACT_ACCELERATION  1000    // E acceleration for retracts (increased for dual drive)
...
#define CLASSIC_JERK
  ...
  #define DEFAULT_EJERK 10.0  // Increased from 5.0 for dual drive extruder
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39, -10, -1.53 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
